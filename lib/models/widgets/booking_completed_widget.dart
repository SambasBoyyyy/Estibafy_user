...
class BuildBookingCompletedCard extends StatefulWidget {
  final BuildContext context;
  final int index;

  const BuildBookingCompletedCard({
    Key? key,
  ...
  @override
  _BuildBookingCompletedCardState createState() =>
      _BuildBookingCompletedCardState();
}

class _BuildBookingCompletedCardState extends State<BuildBookingCompletedCard> {
  @override
  Widget build(BuildContext context) {
    return buildBookingCompleted(widget.context, widget.index);
  }

  buildBookingCompleted(BuildContext context, int index) {
